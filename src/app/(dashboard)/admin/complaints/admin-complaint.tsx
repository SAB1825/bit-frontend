...
import { fetchAllComplaintStats } from "@/lib/queries"
import { AdminComplaintsTable } from "@/components/admin-complaint-table"
import { TodayCreatedComplaintsTable } from "@/components/today-created-complaints"



export const AdminComplaintPageContent = () => {
    const { data: stats, isLoading, error, isError } = useQuery({
        queryKey: ['complaintStats'],
        queryFn: fetchAllComplaintStats,
    })
    ...
    return (
        <>
            ...
            <div className="p-6">
                <p className="font-semibold">Complaints created today</p>
                <TodayCreatedComplaintsTable />
            </div>
            <div className="p-6">
            <p className="font-semibold">Overall Complaints</p>
