...
const SIDEBAR_ITEMS: SidebarCategory[] = [
  {
    category: "Overview",
    items: [{ href: "/staff", icon: LayoutDashboard, text: "Dashboard" }],
  },
  {
    category: "Options",
    items: [
      { href: "/staff/complaints", icon: MessageSquareWarning, text: "Complaints" },
      { href: "/staff/guest-details", icon: Users, text: "Guest Details" }
    ],
  },
  {
    category: "Account",
    items: [
      { href: "/staff/profile", icon: UserCircle, text: "Profile" },
      {
